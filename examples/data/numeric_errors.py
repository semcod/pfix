...
if __name__ == "__main__":
    tests = [
        ("1. Average of empty list", lambda: calculate_average([])),
        ("2. Float precision (0.1+0.2 != 0.3)", lambda: validate_total([{"price": 0.1}, {"price": 0.2}])),
        ("3. NaN propagation", lambda: compute_statistics([1.0, float("nan"), 3.0, 4.0])),
        ("4. Seconds vs milliseconds", lambda: time_ago(1711641600000)),  # ms timestamp
        ("5. Modulo by zero", lambda: distribute_evenly(100, 0)),
    ]
