...
def reset_examples(examples_dir: Path) -> bool:
    ...
    files_to_reset = [f"examples/{cat}/{file}" for cat, file in EXAMPLES]
...
def main():
    parser = argparse.ArgumentParser(description="Run all pfix examples and optionally reset")
    parser.add_argument("--reset", action="store_true", help="Only reset without running tests")
    parser.add_argument("--dry-run", action="store_true", help="Show what would be run without executing")
    parser.add_argument("--no-reset", action="store_true", help="Run tests but don't reset at the end")
